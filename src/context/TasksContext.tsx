...
interface Task {
  id: string
  task_id: string
  task_type: "fetch_paper_metadata" | "send_paper_notification" | "sync_paper_to_elasticsearch" | "remove_paper_from_elasticsearch"
  paper_id: string
  paper_title: string
  status: TaskStatus
  ...
  duration: string
  worker_name: string
  result: string | { paper_title: string title: string } | null
  created_at: string
  updated_at: string
  completed_at: string
}
